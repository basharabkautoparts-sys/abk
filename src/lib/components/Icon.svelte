<script lang="ts" module>
	...
	const ICONS: Record<string, string> = {
		...
		// vehicle brand marker
		car: '<path d="M5 17H3.5a1 1 0 0 1-1-1v-3.2a2 2 0 0 1 .2-.9l1.9-3.8A2 2 0 0 1 6.4 7h11.2a2 2 0 0 1 1.8 1.1l1.9 3.8c.13.28.2.58.2.9V16a1 1 0 0 1-1 1H19"/><path d="M3 12h18"/><circle cx="7.5" cy="17" r="2"/><circle cx="16.5" cy="17" r="2"/>',
		// --- feature strip ---
