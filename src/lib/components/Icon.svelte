<script lang="ts" module>
	...
	// Brand glyphs (filled). NOTE these are bare `d` path data, not elements
	// like ICONS above — they are rendered into a <path d={...}> below. Keep the
	// two shapes distinct: injecting one as the other silently produces an empty
	// <svg> with the coordinates sitting in it as text.
...
{#if filled}
	<svg
		...
		fill="currentColor"
		class={cls}
		aria-hidden="true"><path d={FILLED[name]} /></svg
	>
{:else}
	<svg
		xmlns="http://www.w3.org/2000/svg"
